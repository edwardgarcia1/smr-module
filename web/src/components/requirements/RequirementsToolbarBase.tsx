...
interface RequirementsToolbarBaseProps {
	title: string;
	handleExcelExport: () => void;
	darkMode: boolean;
	selectedCategories: string[];
	setSelectedCategories: (val: string[]) => void;
	/** Extra buttons appended after Excel in the top action bar */
	topActions?: React.ReactNode;
	/** Extra controls rendered before CategoryFilter in the bottom bar */
	bottomControls?: React.ReactNode;
}

const RequirementsToolbarBase: React.FC<RequirementsToolbarBaseProps> = ({
	title,
	handleExcelExport,
	darkMode,
	selectedCategories,
...
export default RequirementsToolbarBase;
